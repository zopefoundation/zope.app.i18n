...
class TestSynchronize(unittest.TestCase):
    ...
    def test_synchronize_imports(self):
        ...
        import zope.app.i18n.browser.synchronize  # noqa: F401 unused
    ...
    def test_create_view_cover(self):
        ...
        s.saveSettings()
        s.synchronize()
        s.queryMessages = lambda: {('short_greeting', 'en'): [
    ...
    def test_make_url(self):
        ...
        s = Synchronize(self._domain, request)
        self.assertEqual(
            'http://admin:admin@localhost:8080/++etc++site/default/zope',
            s._make_sync_url())
